...
risk_bias <- as.data.frame(risk_bias)
rob.summary(risk_bias, name.high = "high", name.unclear = "uc", name.low = "low",
            name.missing = "miss", studies = risk_bias$Study, table = TRUE)